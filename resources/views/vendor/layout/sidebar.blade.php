...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
       ...
       <li class="nav-item">
          <a class="nav-link" href="{{ url('vendor/enquiry') }}">
          <i class="icon-grid menu-icon"></i>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('vendor/update-vendor-password') }}">Change Password</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('vendor/update-personal_detail') }}">Personal Information</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('vendor/update-profile-detail') }}">Profile Detail</a></li>
                </ul>
            </div>
        </li>
       {{-- <li class="nav-item">
