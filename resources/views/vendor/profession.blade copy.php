                            ...
                            <div class="card-body">
                                <div class="profile-photo">
                                    <div class="profile-img">
                                        ...
                                        <div>
                                            <p><strong>Hello,
                                                    {{ Str::title(Auth::guard('vendor')->user()->name) }}</strong>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="profile-form">
                                    ...
                                    @endif
                                    <form action="{{ url('vendor/profession') }}" method="post" class="forms-sample"
                                        ...
                                        <div class="row">
                                                        ...
                                                        <select class="js-example-basic-single form-control"
                                                            ...
                                                            @foreach ($occupations as $occupation)
                                                                <option value="{{ $occupation->id }}"
                                                                    {{ isset($profile) && $profile->occupation_id == $occupation->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex">
                                                        <label class="sr-only" for="experience_year">Experience
                                                            Year</label>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control mr-2"
                                                                name="experience_year" min="0" max="100"
                                                                value="{{ $profile->experience_year ?? '0' }}">
                                                        </div>
                                                        <label class="sr-only" for="experience_month">Experience
                                                            Month</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                            ...
                                                            <input type="number" class="form-control mr-2"
                                                                name="experience_month" min="0" max="11"
                                                                value="{{ $profile->experience_month ?? '0' }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group form-outline">
                                                    <label for="name">Address<span
                                                            class="text-danger"><sup>*</sup></span></label>
                                                    <textarea class="form-control" name="address" id="address" rows="2" value="{{ $profile->address ?? '' }}">{{ $profile->address ?? '' }}</textarea>
                                                    @error('address')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="pass-group group-img">
                                                        ...
                                                        <input type="text" class="form-control" name="price_per_hour"
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="latitude"
                                                        id="latitude" value="{{ $profile->pincode ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="longitude"
                                                        id="longitude" value="{{ $profile->pincode ?? '' }}" readonly>
                                                </div>
                                            </div>
